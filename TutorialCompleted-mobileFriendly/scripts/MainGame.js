...
BasicGame.Game.prototype = {
	...
	create: function () {
        ...
        buttonleft = this.add.button(0, this.world.height / 2, 'leftArrow', null, this, 0, 1, 0, 1);
        ...
        buttonRight =this.add.button(60, this.world.height / 2, 'rightArrow', null, this, 0, 1, 0, 1);
	...
	update: function () {
		...
		//if (gameOver == true){
		//if lifeTotal is less than 1 or seconds = 60 then execute 'gameOver' function
		if (lifeTotal < 1 || seconds == 60) {
			this.gameOver();
		}
